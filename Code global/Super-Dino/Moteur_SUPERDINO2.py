...
class Joueur(Entity):
    ...
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load('images/base_droite.png').convert_alpha()
        ...
        for p in plateformes:
            ...
            # Donc, en cas de collision :
                ...
                if isinstance(p, BlocVictoire):
                    ...
                    # Chargement de l'écran de la victoire et affichage de cet écran
                    ecran_reussite = pygame.image.load('images/BRAVO.png').convert()
                ...
                if isinstance(p, BlocMort):
                    ...
                    ecran_mort = pygame.image.load('images/GAME_OVER.png').convert()
